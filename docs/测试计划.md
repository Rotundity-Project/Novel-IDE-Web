...
| Test | 自动化测试 | PostgreSQL | http://test.novel-ide-web.com |
| Staging | 预发布测试 | PostgreSQL | http://staging.novel-ide-web.com |
| Production | 生产环境 | PostgreSQL | https://novel-ide-web.com |
